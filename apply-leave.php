...
<label for="fromdate">From Date</label>
 <input placeholder="" name="fromdate" type="text" onfocus="(this.type = 'date')"  id="date" required>
</div>

<div class="input-field col m6 s12">
<label for="fromdate">To Date</label>
 <input placeholder="" name="todate" type="text" onfocus="(this.type = 'date')"  id="date" required>
</div>

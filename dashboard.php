...
$sql1 = "SELECT id FROM `tblleaves` WHERE CURDATE() between `FromDate` and `ToDate`";
$query1 = $dbh -> prepare($sql1);
$query1->execute();
$results1=$query1->fetchAll(PDO::FETCH_OBJ);
$dptcount1=$query1->rowCount();

$sum_total = $leavtypcount - $dptcount1;
?>   
                                <span class="stats-counter text-white"><span class="counter"><?php echo htmlentities($sum_total);?></span></span>

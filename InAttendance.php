...
$sql = "SELECT Empcode from attendance where CurDate=CURDATE() AND EmailId=:empid ";
...
$cnt=1;
if($query->rowCount() > 0){
$error="Employee In-Time is already recorded";
$cnt++;}
else{
...
<label for="empcode" style="text-size:20px;display: block; width: 500px;">Employee Code(Must be unique)</label>
<input  name="empcode" id="empcode" onBlur="checkAvailabilityEmpid()" style="width: 170px;" type="text" maxlength="4" autocomplete="off" required>

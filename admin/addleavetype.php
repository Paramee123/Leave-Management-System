  ...
  <?php include('includes/header.php');?>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title" style="color: #396EB0;font-weight:bold;font-size:16px">Add Leave Type</div>
                    </div>
...
<button type="submit" name="add" class="waves-effect blue waves-light btn blue darken-1">ADD</button>

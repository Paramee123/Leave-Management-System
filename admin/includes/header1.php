        ...
        <div class="mn-content fixed-sidebar">
            <header class="mn-header navbar-fixed">
                ...
                <nav class="navbar navbar-expand-lg navbar-light py-3 " style="background-color:#003A6B" >
				<img src="../assets/images/Untitled-1.png" style="width:180px;height:50px;margin-top:3px;">
				<label style="position:absolute;margin-left:200px;margin-top:20px"><span style="font-size:38px;color:#FEFEFE;font-family:'Tahoma';">Human Resource Information System</span>
        </label>

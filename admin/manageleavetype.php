    ...
    <body>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title" style="color: #396EB0;font-weight:bold;font-size:16px">Manage Leave Type</div>
                    </div>
                                ...
                                <table id="example" class="display responsive-table ">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="color: #396EB0;">Leave Type</th>
                                            <th style="color:#396EB0;">Description</th>
                                            <th style="color: #396EB0;">Creation Date</th>

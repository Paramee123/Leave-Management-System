    ...
    <body>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title" style="color: #396EB0;font-weight:bold;font-size:16px">Approved Leave History</div>
                    </div>
                                ...
                                <table id="example" class="display responsive-table ">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="color: #396EB0;" width="180">Employe Name</th>
											 
                                            <th style="color: #396EB0;" width="180">Leave Type</th>

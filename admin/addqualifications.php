...
$sql="INSERT INTO tblemployees(EmpId,FirstName,LastName,EmailId,Password,Gender,Dob,Team,DOL,DOJ,Supervisor,Address,Phonenumber,Status) VALUES(:empid,:fname,:lname,:email,:password,:gender,:dob,:team,:DOL,:DOJ,:supervisor,:address,:mobileno,:status)";
...
$query->bindParam(':DOL',$DOL,PDO::PARAM_STR);
...
<div class="input-field col m6 s12">
<label for="fromdate">Date of Leave</label>
 <input placeholder="" name="DOL" type="text" onfocus="(this.type = 'date')"  id="date">
</div>

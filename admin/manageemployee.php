    ...
    <body>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title" style="color: #396EB0;font-weight:bold;font-size:16px">Manage Employees</div>
                    </div>
                                ...
                                <table id="example" class="display responsive-table ">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="color:#396EB0;">Emp Id</th>
                                            <th style="color: #396EB0;">Emp Name</th>
                                            <th style="color: #396EB0;">Team</th>
                                             <th style="color: #396EB0;">Status</th>
                                             <th style="color: #396EB0;">Reg Date</th>
                                            <th style="color: #396EB0;">Action</th>
                                        </tr>
                                    </thead>
                                 
                                    <tbody>
<?php $sql = "SELECT EmpId,FirstName,LastName,Team,Status,RegDate,id from  tblemployees";
$query = $dbh -> prepare($sql);
$query->execute();
